    ...
    return Controller.extend("rwt.etp.invoicing.controller.CreateInvoice", {
        ...
        onSuggestionItemSelected: function (oEvent) {
            ...
            if (oSelectedItem) {
                ...
                oSelectedData.TotalPrice = ((oSelectedData.Selling_Price + (oSelectedData.Selling_Price*0.18)).toFixed(2) * oSelectedData.Sell_Qty);
        ...
        updateSP:function(oEvent){
            ...
            let GST = SellingPrice*0.18;
            let TotalPrice = (SellingPrice+GST).toFixed(2);
            let NewSP = oModel.setProperty(`${oParentBinding}/TotalPrice`,TotalPrice*oSource.getValue());
            oModel.refresh(true);
        },
